...
public class Signature {
    ...
    public static String getSignSort(Map<String,Object> map){
        ArrayList<String> list = new ArrayList<String>();
      ...
      //  Arrays.sort(arrayToSort, String.CASE_INSENSITIVE_ORDER);
        ...
        String [] arrayToSortKey = keyList.toArray(new String[size]);
        Arrays.sort(arrayToSortKey, String.CASE_INSENSITIVE_ORDER);
        
        StringBuilder sb = new StringBuilder();
        for(int i = 0; i < size; i ++) {
        	String key = arrayToSortKey[i] ;
